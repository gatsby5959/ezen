...
public class Array01 {
	public static void main(String[] args) {
		 ...
		 * //연습할때 선언과 동시에 초기화할때만 가능
		 * 타입[] 배열이름 = {값1, 값2, 값3...}; 
		 * - 배열의 길이는 0이상이여야 한다.
		 * - 배열의 시작번자는 : 0부터 시작
		 * - 배열[5] => 0 1 2 3 4
		 * - 배열의 길이 => length 를 이용하면 배열의 길이를 알수 있음.
		 * */
		
		int a = 10; //일반 변수 선언
		int arr1[]; //선언만 한 경우
		arr1 = new int[5]; //초기화 한경우
		int arr2[] = new int[5]; //일반적인 방식
		int arr3[] = new int[] {1,2,3,4,5};
		int arr4[] = {1,2,3,4,5}; //선언과 동시에 초기화 할때만 가능
		
		/* 배열을 사용하는 이유
		 * 관리가 편함, 반복문을 사용할 수 있기 때문에 많은양의 데이터도 쉽게 사용할수 있음.
		 * 배열의 번지는 0부터시작 길이는 개수로 표현되기 때문에
